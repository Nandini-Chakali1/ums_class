...
# mptive of this project is to revise import python concepts
...
# college class is storing college name and students list
...
# baesd upon college name, college class object is find
